...
!!! note "Nota"
    ...
    A partir de radiación ```48,5``` el tiempo de recarga es mayor que el tiempo de trabajo automático ```(2%, 12 seg)```, por lo que se deja de conseguir oro.
...
!!! note "Nota"
        ...
        Ninguna de ellas presenta un límite de almacenaje de dinero (€).
